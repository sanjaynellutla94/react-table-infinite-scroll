...
import { getTableDataFact, getXHRErrorMeta } from "./api";
...
const App = () => {
  ...
  const generateTableColumns = useCallback(() => {
    const data: any = [
      ...
      { label: "Trips", key: "trips", hasSort: false },
      {
        ...
        hasSort: false,
        renderItem: () => (
          <div className="text-primary">Airline (Custom component)</div>
        ),
      },
  ...
  const getnerateMetadata = useCallback(
    (data: any) => {
      setMeta({
        ...meta,
        ...data,
  ...
  const loadingContent = (
    <div className="text-center">
      {meta.isLoading && <div className="spinner-border" role="status"></div>}
    </div>
  );
